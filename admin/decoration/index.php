    ...
    <main>
        <div class="container">
            ...
            <table class="styled-table">
                ...
                <?php
                    if ($search) {
                        $stmt = $pdo->prepare("SELECT * FROM decoration WHERE nom LIKE ?");
                        $stmt->execute(['%' . $search . '%']);
                    } else {
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<a href='delete.php?id={$row['id']}' class='delete-action actions rouge' title='Supprimer' onclick='return confirm(\"Voulez-vous vraiment supprimer cette décoration ?\");'><i class='fas fa-trash-alt'></i></a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>

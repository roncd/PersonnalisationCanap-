      ...
      <form class="formulaire-creation-compte">
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" id="nom"  class="input-field" require>
          </div>
          <div class="form-group">
            <label for="prenom">Prénom</label>
            <input type="text" id="prenom" class="input-field" require>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" id="adresse-livraison" class="input-field" require>
          </div>
          <div class="form-group">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" id="code-postal" class="input-field" require>
          </div>
          <div class="form-group">
            <label for="ville">Ville</label>
            <input type="text" id="ville"  class="input-field" require>
          </div>
        </div>
      </form>
      <div class="footer">

...
$stmt = $pdo->query("SELECT * FROM modele_bois");
$modele_bois = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<div class="fil-ariane-container" aria-label="fil-ariane">
  ...
  <div class="container">
    ...
    <div class="left-column">
      ...
      <?php if (!empty($modele_bois)): ?>
    <?php foreach ($modele_bois as $modele_bois): ?>
        <div class="option transition">
            <img src="../../admin/uploads/motif-bois/<?php echo htmlspecialchars($modele_bois['img']); ?>" alt="<?php echo htmlspecialchars($modele_bois['nom']); ?>">
            <p><?php echo htmlspecialchars($modele_bois['nom']); ?></p>
            <p><strong><?php echo htmlspecialchars($modele_bois['prix']); ?> €</strong></p>
        </div>
        <?php endforeach; ?>
          <?php else: ?>

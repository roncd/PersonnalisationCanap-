...
<main>
  <div class="container">
    ...
    <div class="left-column">
      ...
      <form class="formulaire-creation-compte">
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="email" id="adresse"  class="input-field">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group">
      ...
      <div class="footer">
        <p>Tu n'as pas de compte ? <span><a href="https://diangou-cmr.alwaysdata.net/processus-personalisation/formulaire/CreationCompte.php#" class="link-connect">Inscris-toi</a></span></p>
        <div class="buttons">
